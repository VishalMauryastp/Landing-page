      ...
      <div className="flex max-lg:flex-col gap-16 w-[90%] mx-auto py-12 lg:py-20">
        ...
        <div className="lg:w-[70%]">
          <div className="">
            ...
            <h1 className="text-[27px] md:text-[36px] lmd:eading-[50px] mt-8 font-redhat font-bold">
            ...
            <div className="flex max-md:flex-col gap-6  mt-8">
              <div className="md:w-[35%] h-fit p-2 bg-white drop-shadow-2xl shadow-2xl">
                <Image
                  className="w-full"
                  width={400}
                  height={500}
              ...
              <div className="  max-md:mt-8 md:w-[65%] font-poppins   text-justify text-[#222]">
