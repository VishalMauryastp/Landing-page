      ...
      <div className="w-[90%] mx-auto">
        <div className="flex max-lg:flex-col gap-8">
          <div className="lg:w-[60%]">
            <p className="p-1 font-poppins font-bold text-[14px] bg-[#d7e4fd] w-fit ">
              Trusted by Over 1000+ Companies
            </p>
            <h4 className="text-[27px] max-md:leading-tight md:text-[34px] font-redhat text-[#212529] font-bold mt-4">
            ...
            <h4 className="mt-4 text-[22px] font-redhat text-[#212529] font-bold">
