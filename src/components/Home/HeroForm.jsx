      ...
      >
        ...
        <form className="Hero_form text-[#999] font-poppins ">
          <div className={`grid   ${oneline ? "" : "grid-cols-2 gap-4"}`}>
            <div className="w-full relative group mt-[30px]">
              <input
                type="text"
                id="name"
                name="name"
                required
                className="w-full h-7 px-4 text-sm peer bg-transparent outline-none focus:border-blue-500  border-b border-gray-500"
              />
              <label
                htmlFor="name"
          ...
          <button className="py-3 rounded-xl bg-[#e31a20] mt-8 w-full  font-poppins text-white text-[16px] md:text-xl ">
            SEND REQUEST
          </button>
        </form>
      </div>
