        ...
        <div className="md:p-[30px] flex max-lg:flex-col bg-white md:drop-shadow-2xl md:border rounded-2xl mt-8">
          <div className="lg:w-[50%] ">
            <div className="flex items-center ">
              ...
              <div className="w-[75%]">
                <h2 className="text-[22px] max-md:text-center font-redhat text-[#212529] font-bold">
                  We’ve driven over
                </h2>
                <div className="w-[80%] max-md:mx-auto py-4 grid grid-cols-6 gap-2 text-[27px] md:text-[45px] font-[800] text-white font-poppins">
                  <span className="md:px-2 text-center  rounded bg-[#e53036]">
                    6
                  </span>
                  <span className="md:px-2 text-center  rounded bg-[#e53036]">
                    8
            ...
            <div className="lg:w-[70%] grid grid-cols-2  gap-6 mt-8">
              <div className="text-center p-[20px_10px] text-white bg-[#4582FF]   rounded-2xl">
                <h1 className="text-[36px] font-redhat font-bold ">3x</h1>
                <p className="mt-[2px]  ">Growth in Revenue Generated</p>
              </div>
              <div className="text-center p-[20px_10px] text-white  bg-[#f49200] rounded-2xl ">
                <h1 className="text-[36px] font-redhat font-bold rounded-2xl ">
                  4x
                </h1>
                <p className="mt-[2px]  ">Increase in Organic Leads</p>
              </div>
            </div>
          </div>
