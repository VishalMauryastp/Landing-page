    ...
    <div id="services" className=" py-20 text-white">
      <div className="w-[90%] mx-auto">
        ...
        <div className="flex max-lg:flex-col lg:justify-between lg:items-center mt-8">
          ...
          <button className=" bg-[#E31A20] max-lg:w-fit max-lg:mt-8 group flex justify-center border border-black text-white  hover:bg-opacity-0  hover:text-[#E31A20] hover:border-[#E31A20]    transition-all duration-300  group   rounded text-[18px] font-bold   items-center gap-1 p-[10px_15px]">
            {" "}
