      ...
      <div className="w-[90%] mx-auto flex max-lg:flex-col gap-8 lg:gap-12 ">
        <div className="lg:w-[50%]  ">
          <div className="lg:sticky lg:top-0 ">
            <div className="relative w-[100%] overflow-hidden min-h-[300px] lg:min-h-[600px] ">
              <Image
        ...
        <div className="lg:w-[50%]">
          <h1 className="font-poppins text-[27px] md:text-[36px]  font-bold text-[#212529]">
          ...
          <h2 className="font-poppins text-[22px] md:text-[36px]  font-bold text-[#212529]">
